...
char funcType[1000] = {"BatchPD_ROIS"};
...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchPD_ROIS_gpu(d_input, srcSize,maxSize, d_output, dstSize,maxDstSize, affine,roiPoints,noOfImages, handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchPD_ROIS : "<<cpu_time_used<<endl;  

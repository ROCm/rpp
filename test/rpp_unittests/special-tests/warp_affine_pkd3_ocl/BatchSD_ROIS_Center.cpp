...
char funcType[1000] = {"BatchSD_ROIS_Center"};
...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchSD_ROIS_gpu(d_input, srcSize[0], d_output, dstSize, affine,roiPoints,noOfImages, handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchSD_ROIS_Center : "<<cpu_time_used<<endl;  

...
char funcType[1000] = {"BatchDD_ROIS"};
...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchDD_ROIS_gpu(d_input, srcSize, d_output, dstSize, affine,roiPoints,noOfImages,handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchDD_ROIS : "<<cpu_time_used<<endl;  

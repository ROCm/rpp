...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, dstSize, affine,noOfImages,handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchDD : "<<cpu_time_used<<endl;  

...
char funcType[1000] = {"BatchPS_ROIS"};
...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchPS_ROIS_gpu(d_input, srcSize, maxSize,d_output, dstSize[0], dstSize[0],affine,roiPoints,noOfImages, handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchPS_ROIS : "<<cpu_time_used<<endl;  

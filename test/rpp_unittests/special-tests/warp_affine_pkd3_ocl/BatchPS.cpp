...
int main(int argc, char **argv)
{
	...
	rppi_warp_affine_u8_pkd3_batchPS_gpu(d_input, srcSize, maxSize,d_output, dstSize[0], dstSize[0],affine,noOfImages, handle);

    end = clock();
	cpu_time_used = ((double) (end - start)) / CLOCKS_PER_SEC;
	cout<<" BatchPS : "<<cpu_time_used<<endl;  

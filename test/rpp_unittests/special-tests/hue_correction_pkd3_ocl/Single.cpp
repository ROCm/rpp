...
int G_IP_CHANNEL = 3;
int G_MODE = 1;
char src[1000] = {"/home/neel/Lokesh/Testing-Framework/Input_Images/RGBS"};
char dst[1000] = {"/home/neel/Lokesh/Testing-Framework/output_images"};
 char funcName[1000] = {"hue_correction"};
...
int main(int argc, char **argv)
{
    ...
    closedir(dr2); 
	Rpp32f minhue = 0.5, maxhue = 1, hue;
	hue = minhue;
	...
	start = clock();
    float sat = 0.02;
	//rppi_hueRGB_u8_pkd3_gpu(d_input, srcSize[0], d_output, hue, handle);
    rppi_saturationRGB_u8_pkd3_gpu(d_input, srcSize[0], d_output, sat, handle);

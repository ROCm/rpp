non_roi_functions = {"snow","rain","fog","data_object_copy","harris_corner_detector","fast_corner_detector","histogram_balance","histogram_equalization","gaussian_image_pyramid","laplacian_image_pyramid","canny_edge_detector","channel_extract","random_shadow","resize_crop"}
...
local_folder = '/home/neel/Lokesh/Testing-Framework/Geometric-Testing/'

csv_name = '/home/neel/Lokesh/Testing-Framework/Geometric-Testing/Test_Scripts/Test_CSV.csv'

code_folder = '/home/neel/Lokesh/Testing-Framework/Geometric-Testing/Test-files/'
...
non_padding_ioBuffer_for_DS = """
    ...
    while ((de = readdir(dr1)) != NULL) 
    {
        ...
        srcSize[count].height = image.rows;
        srcSize[count].width = image.cols;
        dstSize[count].height = 1000;
        dstSize[count].width = 1000;
        ioBufferSize += (unsigned long long)srcSize[count].height * (unsigned long long)srcSize[count].width * (unsigned long long)ip_channel;
        oBufferSize += (unsigned long long)dstSize[count].height * (unsigned long long)dstSize[count].width * (unsigned long long)ip_channel;
"""
padding_ioBuffer ="""

...
Input | fmadd_scalar (brightened 3D image) | slice (tensor cube sliced in X and Z dims) | fmadd_scalar with slice (tensor cube sliced in X and Z dims and brightened)
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:

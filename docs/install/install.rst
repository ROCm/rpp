...
* Instructions for building RPP with the **HIP** GPU backend (default GPU backend):
  ...
  + Run tests - `test option instructions <https://github.com/ROCm/MIVisionX/wiki/CTest>`_
    ...
    .. note::
        `make test` requires installation of `test suite prerequisites <https://github.com/ROCm/rpp/tree/docs/6.1.0/utilities/test_suite/README.md>`_.
...
.. note::
  Installation of `test suite prerequisites <https://github.com/ROCm/rpp/tree/docs/6.1.0/utilities/test_suite/README.md>`_ is required to run tests

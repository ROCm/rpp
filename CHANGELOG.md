...
* RPP Restructure - Consolidate handle creation and destruction APIs (#513) - Consolidate all handle creation APIs into just 2 - rppCreate and rppDestroy for handle initialization and destruction

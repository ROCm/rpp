...
// ----------------------------------------
// GPU control_flow functions declaration 
// ----------------------------------------
/* control flow on two operands
*param[in] srcPt1 input 1
*param[in] srcPtr2 input 2
*param[in] srcSize input size
*param[out] dstPtr output
*param[in] type control flow type
*returns a  RppStatus enumeration. 
*retval RPP_SUCCESS : No error succesful completion
*retval RPP_ERROR : Error  
*/
...
// ----------------------------------------
// CPU control_flow functions declaration 
// ----------------------------------------
/* control flow on two operands
*param[in] srcPt1 input 1
*param[in] srcPtr2 input 2

...
// ----------------------------------------
// GPU optical_flow_pyramid functions calls 
// -----------------------------
RppStatus
rppi_optical_flow_pyramid_u8_pln1_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize srcSize, 
                                       Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
                                       Rpp32u numPoints, Rpp32f threshold, Rpp32u numIterations, Rpp32u kernelSize);

RppStatus
rppi_optical_flow_u8_pln1_batchPD_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize *srcSize, RppiSize maxSrcSize, 
									Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
									Rpp32u *numPoints, Rpp32f *threshold, Rpp32u *numIterations, Rpp32u *kernelSize, 
									Rpp32u nbatchSize, rppHandle_t rppHandle);

RppStatus
rppi_optical_flow_pyramid_u8_pln3_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize srcSize, 
                                       Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
                                       Rpp32u numPoints, Rpp32f threshold, Rpp32u numIterations, Rpp32u kernelSize);

RppStatus
rppi_optical_flow_u8_pln3_batchPD_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize *srcSize, RppiSize maxSrcSize, 
									Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
									Rpp32u *numPoints, Rpp32f *threshold, Rpp32u *numIterations, Rpp32u *kernelSize, 
									Rpp32u nbatchSize, rppHandle_t rppHandle);

RppStatus
rppi_optical_flow_pyramid_u8_pkd3_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize srcSize, 
                                       Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
                                       Rpp32u numPoints, Rpp32f threshold, Rpp32u numIterations, Rpp32u kernelSize);

RppStatus
rppi_optical_flow_u8_pkd3_batchPD_gpu(RppPtr_t srcPtr1, RppPtr_t srcPtr2, RppiSize *srcSize, RppiSize maxSrcSize, 
									Rpp32u* oldPoints, Rpp32u* newPointsEstimates, Rpp32u* newPoints, 
									Rpp32u *numPoints, Rpp32f *threshold, Rpp32u *numIterations, Rpp32u *kernelSize, 
									Rpp32u nbatchSize, rppHandle_t rppHandle);

...
rppi_local_binary_pattern_u8_pln1_host(RppPtr_t srcPtr,RppiSize srcSize,RppPtr_t dstPtr)
{
	 ...
	 local_binary_pattern_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), 
			srcSize,
...
rppi_data_object_copy_u8_pln1_host(RppPtr_t srcPtr,RppiSize srcSize,RppPtr_t dstPtr)
{
 	 ...
 	 validate_image_size(srcSize);
	 data_object_copy_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), 
			srcSize,
			static_cast<Rpp8u*>(dstPtr), 
			RPPI_CHN_PLANAR, 1);
	return RPP_SUCCESS;
...
rppi_gaussian_image_pyramid_u8_pln1_host(RppPtr_t srcPtr,RppiSize srcSize,RppPtr_t dstPtr,Rpp32f stdDev,Rpp32u kernelSize)
{
	 ...
	 gaussian_image_pyramid_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), 
			srcSize,
			static_cast<Rpp8u*>(dstPtr), 
			stdDev,
			kernelSize,
...
rppi_laplacian_image_pyramid_u8_pln1_host(RppPtr_t srcPtr,RppiSize srcSize,RppPtr_t dstPtr,Rpp32f stdDev,Rpp32u kernelSize)
{
 	 ...
 	 validate_image_size(srcSize);
 	 validate_float_min(0, &stdDev);
	 laplacian_image_pyramid_host<Rpp8u>(static_cast<Rpp8u*>(srcPtr), 
			srcSize,
			static_cast<Rpp8u*>(dstPtr), 
			stdDev,
			kernelSize,
...
// ----------------------------------------
// GPU local_binary_pattern functions  calls 
// ----------------------------------------
...
// ----------------------------------------
// GPU data_object_copy functions  calls 
// ----------------------------------------
...
// ----------------------------------------
// GPU gaussian_image_pyramid functions  calls 
// ----------------------------------------
...
// ----------------------------------------
// GPU laplacian_image_pyramid functions  calls 
// ----------------------------------------

...
template RppStatus hip_exec_flip_voxel_tensor<Rpp8u>(Rpp8u*,
                                                     RpptGenericDescPtr,
                                                     Rpp8u*,
                                                     RpptGenericDescPtr,
                                                     RpptROI3DPtr,
                                                     ...
                                                     RpptRoi3DType,
                                                     rpp::Handle&);
template RppStatus hip_exec_flip_voxel_tensor<half>(half*,
                                                    RpptGenericDescPtr,
                                                    half*,
                                                    RpptGenericDescPtr,
                                                    RpptROI3DPtr,
                                                    ...
                                                    RpptRoi3DType,
                                                    rpp::Handle&);
template RppStatus hip_exec_flip_voxel_tensor<Rpp32f>(Rpp32f*,
                                                      RpptGenericDescPtr,
                                                      Rpp32f*,
                                                      RpptGenericDescPtr,
                                                      RpptROI3DPtr,
                                                      ...
                                                      RpptRoi3DType,
                                                      rpp::Handle&);
template RppStatus hip_exec_flip_voxel_tensor<Rpp8s>(Rpp8s*,
                                                     RpptGenericDescPtr,
                                                     Rpp8s*,
                                                     RpptGenericDescPtr,
                                                     RpptROI3DPtr,

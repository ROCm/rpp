							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		...
		{
			non_linear_blend_hip_batch_tensor<Rpp8u, Rpp8u>(
		...
		{
			non_linear_blend_hip_batch_tensor<Rpp16f, Rpp16f>(
		...
		{
			non_linear_blend_hip_batch_tensor<Rpp32f, Rpp32f>(
		...
		{
			non_linear_blend_hip_batch_tensor<Rpp8s, Rpp8s>(
							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			water_hip_batch_tensor<Rpp8u, Rpp8u>(
		...
		{
			water_hip_batch_tensor<Rpp16f, Rpp16f>(
		...
		{
			water_hip_batch_tensor<Rpp32f, Rpp32f>(
		...
		{
			water_hip_batch_tensor<Rpp8s, Rpp8s>(
							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			erase_hip_batch_tensor<Rpp8u, Rpp8u>(
				static_cast<Rpp8u *>(srcPtr),
				static_cast<Rpp8u *>(dstPtr),
		...
		{
			erase_hip_batch_tensor<Rpp16f, Rpp16f>(
				static_cast<Rpp16f *>(srcPtr),
				static_cast<Rpp16f *>(dstPtr),
				static_cast<Rpp32u *>(anchor_box_info),
		...
		{
			erase_hip_batch_tensor<Rpp32f, Rpp32f>(
				static_cast<Rpp32f *>(srcPtr),
				static_cast<Rpp32f *>(dstPtr),
				static_cast<Rpp32u *>(anchor_box_info),
		...
		{
			erase_hip_batch_tensor<Rpp8s, Rpp8s>(
				static_cast<Rpp8s *>(srcPtr),
				static_cast<Rpp8s *>(dstPtr),
				static_cast<Rpp32u *>(anchor_box_info),
							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			color_cast_hip_batch_tensor<Rpp8u, Rpp8u>(
				static_cast<Rpp8u *>(srcPtr),
				static_cast<Rpp8u *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			color_cast_hip_batch_tensor<Rpp16f, Rpp16f>(
				static_cast<Rpp16f *>(srcPtr),
				static_cast<Rpp16f *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			color_cast_hip_batch_tensor<Rpp32f, Rpp32f>(
				static_cast<Rpp32f *>(srcPtr),
				static_cast<Rpp32f *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			color_cast_hip_batch_tensor<Rpp8s, Rpp8s>(
				static_cast<Rpp8s *>(srcPtr),
				static_cast<Rpp8s *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
...
rppi_color_cast_u8_pln1_batchPD_host(RppPtr_t srcPtr, RppiSize *srcSize, RppiSize maxSrcSize, RppPtr_t dstPtr, Rpp8u *r, Rpp8u *g, Rpp8u *b, Rpp32f *alpha,
									 Rpp32u outputFormatToggle, Rpp32u nbatchSize, rppHandle_t rppHandle)
{
	return ( color_cast_host_helper(RPPI_CHN_PLANAR,1, RPPTensorDataType::U8, RPPTensorDataType::U8, outputFormatToggle,
							   srcPtr, srcSize, maxSrcSize, dstPtr , r, g, b, alpha , nbatchSize, rppHandle));
}
...
rppi_color_cast_f32_pln1_batchPD_host(RppPtr_t srcPtr, RppiSize *srcSize, RppiSize maxSrcSize, RppPtr_t dstPtr, Rpp8u *r, Rpp8u *g, Rpp8u *b, Rpp32f *alpha,
									 Rpp32u outputFormatToggle, Rpp32u nbatchSize, rppHandle_t rppHandle)
{
	return ( color_cast_host_helper(RPPI_CHN_PLANAR, 1, RPPTensorDataType::FP32, RPPTensorDataType::FP32, outputFormatToggle,
							   srcPtr, srcSize, maxSrcSize, dstPtr , r, g, b, alpha , nbatchSize, rppHandle));
}
...
rppi_color_cast_f16_pln1_batchPD_host(RppPtr_t srcPtr, RppiSize *srcSize, RppiSize maxSrcSize, RppPtr_t dstPtr, Rpp8u *r, Rpp8u *g, Rpp8u *b, Rpp32f *alpha,
									 Rpp32u outputFormatToggle, Rpp32u nbatchSize, rppHandle_t rppHandle)
{
	return ( color_cast_host_helper(RPPI_CHN_PLANAR, 1, RPPTensorDataType::FP16, RPPTensorDataType::FP16, outputFormatToggle,
							   srcPtr, srcSize, maxSrcSize, dstPtr , r, g, b, alpha , nbatchSize, rppHandle));
}
...
rppi_color_cast_i8_pln1_batchPD_host(RppPtr_t srcPtr, RppiSize *srcSize, RppiSize maxSrcSize, RppPtr_t dstPtr, Rpp8u *r, Rpp8u *g, Rpp8u *b, Rpp32f *alpha,
									 Rpp32u outputFormatToggle, Rpp32u nbatchSize, rppHandle_t rppHandle)
{
	return ( color_cast_host_helper(RPPI_CHN_PLANAR,1, RPPTensorDataType::I8, RPPTensorDataType::I8, outputFormatToggle,
							   srcPtr, srcSize, maxSrcSize, dstPtr , r, g, b, alpha , nbatchSize, rppHandle));
}
							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			lut_hip_batch_tensor<Rpp8u, Rpp8u>(
				static_cast<Rpp8u *>(srcPtr),
				static_cast<Rpp8u *>(dstPtr),
		...
		{
			lut_hip_batch_tensor<Rpp8s, Rpp8s>(
				static_cast<Rpp8s *>(srcPtr),
				static_cast<Rpp8s *>(dstPtr),
							 ...
							 Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			crop_and_patch_hip_batch_tensor<Rpp8u, Rpp8u>(
				static_cast<Rpp8u *>(srcPtr1),
				static_cast<Rpp8u *>(srcPtr2),
				static_cast<Rpp8u *>(dstPtr),
				rpp::deref(rppHandle),
		...
		{
			crop_and_patch_hip_batch_tensor<Rpp16f, Rpp16f>(
				static_cast<Rpp16f *>(srcPtr1),
				static_cast<Rpp16f *>(srcPtr2),
				static_cast<Rpp16f *>(dstPtr),
				rpp::deref(rppHandle),
		...
		{
			crop_and_patch_hip_batch_tensor<Rpp32f, Rpp32f>(
				static_cast<Rpp32f *>(srcPtr1),
				static_cast<Rpp32f *>(srcPtr2),
				static_cast<Rpp32f *>(dstPtr),
				rpp::deref(rppHandle),
		...
		{
			crop_and_patch_hip_batch_tensor<Rpp8s, Rpp8s>(
				static_cast<Rpp8s *>(srcPtr1),
				static_cast<Rpp8s *>(srcPtr2),
				static_cast<Rpp8s *>(dstPtr),
				rpp::deref(rppHandle),
						...
						Rpp32u nbatchSize, rppHandle_t rppHandle)
{
...
#elif defined(HIP_COMPILE)
	{
		if (in_tensor_type == RPPTensorDataType::U8)
		{
			glitch_hip_batch_tensor<Rpp8u, Rpp8u>(
				static_cast<Rpp8u *>(srcPtr),
				static_cast<Rpp8u *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			glitch_hip_batch_tensor<Rpp16f, Rpp16f>(
				static_cast<Rpp16f *>(srcPtr),
				static_cast<Rpp16f *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			glitch_hip_batch_tensor<Rpp32f, Rpp32f>(
				static_cast<Rpp32f *>(srcPtr),
				static_cast<Rpp32f *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);
		...
		{
			glitch_hip_batch_tensor<Rpp8s, Rpp8s>(
				static_cast<Rpp8s *>(srcPtr),
				static_cast<Rpp8s *>(dstPtr),
				rpp::deref(rppHandle),
				tensor_info);

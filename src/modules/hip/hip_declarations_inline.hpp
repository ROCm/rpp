...
template <typename T, typename U>
RppStatus
non_linear_blend_hip_batch_tensor(T* srcPtr1, T* srcPtr2, U* dstPtr, rpp::Handle &handle, 
...
template <typename T, typename U>
RppStatus
erase_hip_batch_tensor(T* srcPtr, U* dstPtr, Rpp32u* anchor_box_info, T* colors, Rpp32u* box_offset,
...
{ 
    ...
    handle.AddKernel("", "", "tensor.cpp", kernel_name, vld, vgd, "")(
                                                                    srcPtr,
                                                                    dstPtr,
                                                                    d_out_dims,
                                                                    d_perm,

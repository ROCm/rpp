                                 ...
                                 uint2 srcWH)
{
    ...
    else if ((id_y >= 0) && (id_x >= cropRegion[0].xywhROI.roiWidth * 3) && (id_y < (cropRegion[1].xywhROI.roiHeight)) && (id_x < (srcWH.x * 3)))
    ...
    else if ((id_y >= cropRegion[1].xywhROI.roiHeight) && (id_x >= 0) && (id_y < (srcWH.y)) && (id_x < cropRegion[2].xywhROI.roiWidth * 3))
    ...
    else if ((id_y >= cropRegion[1].xywhROI.roiHeight) && (id_x >= cropRegion[2].xywhROI.roiWidth * 3) && (id_y < (srcWH.y)) && (id_x < (srcWH.x * 3)))
                                 ...
                                 uint2 srcWH)
{
    ...
    else if ((id_y >= 0) && (id_x >= cropRegion[0].xywhROI.roiWidth) && (id_y < (cropRegion[1].xywhROI.roiHeight)) && (id_x < (srcWH.x)))
    ...
    else if ((id_y >= cropRegion[1].xywhROI.roiHeight) && (id_x >= 0) && (id_y < (srcWH.y)) && (id_x < cropRegion[2].xywhROI.roiWidth))
    ...
    else if ((id_y >= cropRegion[1].xywhROI.roiHeight) && (id_x >= cropRegion[2].xywhROI.roiWidth) && (id_y < (srcWH.y)) && (id_x < (srcWH.x)))

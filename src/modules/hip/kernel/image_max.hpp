...
template <typename T>
__global__ void tensor_max_grid_3channel_result(float *srcPtr,
                                                uint xBufferLength,
                                                T *dstPtr)
{
...
template <typename T>
__global__ void tensor_max_grid_result(float *srcPtr,
                                       uint xBufferLength,
                                       T *dstPtr)
{
    int id_x = hipThreadIdx_x * 8;
...
template <typename T>
__global__ void tensor_max_pkd3(T *srcPtr,
                                uint2 srcStridesNH,
                                float *imageMaxArr,
...
template <typename T>
__global__ void tensor_max_pln3(T *srcPtr,
                                uint3 srcStridesNCH,
                                float *imageMaxArr,
                                RpptROIPtr roiTensorPtrSrc)
{
...
template <typename T>
__global__ void tensor_max_pln1(T *srcPtr,
                                uint2 srcStridesNH,
                                float *imageMaxArr,
                                RpptROIPtr roiTensorPtrSrc)
{
                              ...
                              rpp::Handle& handle)
{
    ...
    if ((srcDescPtr->c == 1) && (srcDescPtr->layout == RpptLayout::NCHW))
    {
        ...
        hipLaunchKernelGGL(tensor_max_pln1,
                           ...
                           roiTensorPtrSrc);
        hipDeviceSynchronize();
        hipLaunchKernelGGL(tensor_max_grid_result,
                           dim3(1, 1, gridDim_z),
                           dim3(256, 1, 1),
                           0,
                           handle.GetStream(),
    ...
    else if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NCHW))
    {
        ...
        hipLaunchKernelGGL(tensor_max_pln3,
                           dim3(gridDim_x, gridDim_y, gridDim_z),
                           dim3(localThreads_x, localThreads_y, localThreads_z),
                           0,
                           handle.GetStream(),
                           ...
                           imagePartialMaxArr,
                           roiTensorPtrSrc);
        hipLaunchKernelGGL(tensor_max_grid_3channel_result,
                           dim3(1, 1, gridDim_z),
                           dim3(256, 1, 1),
                           0,
                           handle.GetStream(),
    ...
    else if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NHWC))
    {
        ...
        hipLaunchKernelGGL(tensor_max_pkd3,
                           dim3(gridDim_x, gridDim_y, gridDim_z),
                           dim3(localThreads_x, localThreads_y, localThreads_z),
                           0,
                           handle.GetStream(),

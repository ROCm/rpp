...
//     spatter_hip_compute(&src1_f24.x, &src2_f24.x, &dst_f24.x, &alpha_f4);
//     spatter_hip_compute(&src1_f24.y, &src2_f24.y, &dst_f24.y, &alpha_f4);
//     spatter_hip_compute(&src1_f24.z, &src2_f24.z, &dst_f24.z, &alpha_f4);
//     rpp_hip_pack_float24_pln3_and_store24_pln3(dstPtr, dstIdx, dstStridesNCH.y, &dst_f24);
// }

// template <typename T>
// __global__ void spatter_pln3_pkd3_tensor(T *srcPtr1,
//                                        T *srcPtr2,
//                                        uint3 srcStridesNCH,
//                                        T *dstPtr,
//                                        uint2 dstStridesNH,

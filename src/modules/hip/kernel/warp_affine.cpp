...
extern "C" __global__ void warp_affine_batch(
    unsigned char *srcPtr, unsigned char *dstPtr,
    float *affine, unsigned int *source_height,
...
extern "C" __global__ void warp_affine_batch_fp32(
    float *srcPtr, float *dstPtr, float *affine,
...
extern "C" __global__ void warp_affine_batch_int8(
    char *srcPtr, char *dstPtr, float *affine,
    unsigned int *source_height, unsigned int *source_width,
    unsigned int *dest_height, unsigned int *dest_width,
    unsigned int *xroi_begin, unsigned int *xroi_end,
    unsigned int *yroi_begin, unsigned int *yroi_end,

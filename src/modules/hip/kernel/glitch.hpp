...
template <typename T>
__device__ __forceinline__ void rpp_hip_load8_glitch(T *srcPtr, uint srcStrideH, d_float8 *srcX_f8, d_float8 *srcY_f8, int4 *roiPtrSrc_i4, d_float8 *dst_f8, int channelStride, int chn)
{
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[0], srcY_f8->f1[0], roiPtrSrc_i4, &(dst_f8->f1[0]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[1], srcY_f8->f1[1], roiPtrSrc_i4, &(dst_f8->f1[1]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[2], srcY_f8->f1[2], roiPtrSrc_i4, &(dst_f8->f1[2]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[3], srcY_f8->f1[3], roiPtrSrc_i4, &(dst_f8->f1[3]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[4], srcY_f8->f1[4], roiPtrSrc_i4, &(dst_f8->f1[4]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[5], srcY_f8->f1[5], roiPtrSrc_i4, &(dst_f8->f1[5]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[6], srcY_f8->f1[6], roiPtrSrc_i4, &(dst_f8->f1[6]), channelStride, chn);
    rpp_hip_load1_glitch(srcPtr, srcStrideH, srcX_f8->f1[7], srcY_f8->f1[7], roiPtrSrc_i4, &(dst_f8->f1[7]), channelStride, chn);
}
                                      ...
                                      RpptROIPtr roiTensorPtrSrc)
{
    ...
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[0], &srcLocsY_f24.f8[0], &srcRoi_i4, &(dst_f24.f8[0]), 3, 0);
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[1], &srcLocsY_f24.f8[1], &srcRoi_i4, &(dst_f24.f8[1]), 3, 1);
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[2], &srcLocsY_f24.f8[2], &srcRoi_i4, &(dst_f24.f8[2]), 3, 2);
                                      ...
                                      RpptROIPtr roiTensorPtrSrc)
{
    ...
    compute_glitch_locs_hip(id_x, id_y, rgbOffsets, roiTensorPtrSrc[id_z], &srcLocsX_f24, &srcLocsY_f24);
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[0], &srcLocsY_f24.f8[0], &srcRoi_i4, &dst_f8, 1, 0);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);

    srcIdx += srcStridesNCH.y;
    dstIdx += dstStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[1], &srcLocsY_f24.f8[1], &srcRoi_i4, &dst_f8, 1, 0);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);

    srcIdx += srcStridesNCH.y;
    dstIdx += dstStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[2], &srcLocsY_f24.f8[2], &srcRoi_i4, &dst_f8, 1, 0);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);
}
                                            ...
                                            RpptROIPtr roiTensorPtrSrc)
{
    ...
    compute_glitch_locs_hip(id_x, id_y, rgbOffsets, roiTensorPtrSrc[id_z], &srcLocsX_f24, &srcLocsY_f24);
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[0], &srcLocsY_f24.f8[0], &srcRoi_i4, &dst_f8, 3, 0);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);

    dstIdx += dstStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[1], &srcLocsY_f24.f8[1], &srcRoi_i4, &dst_f8, 3, 1);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);

    dstIdx += dstStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNH.y, &srcLocsX_f24.f8[2], &srcLocsY_f24.f8[2], &srcRoi_i4, &dst_f8, 3, 2);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);
}
                                            ...
                                            RpptROIPtr roiTensorPtrSrc)
{
    ...
    d_float24 dst_f24, srcLocsX_f24, srcLocsY_f24;
    compute_glitch_locs_hip(id_x, id_y, rgbOffsets, roiTensorPtrSrc[id_z], &srcLocsX_f24, &srcLocsY_f24);
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[0], &srcLocsY_f24.f8[0], &srcRoi_i4, &(dst_f24.f8[0]), 1, 0);

    srcIdx += srcStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[1], &srcLocsY_f24.f8[1], &srcRoi_i4, &(dst_f24.f8[1]), 1, 0);

    srcIdx += srcStridesNCH.y;
    rpp_hip_load8_glitch(srcPtr + srcIdx, srcStridesNCH.z, &srcLocsX_f24.f8[2], &srcLocsY_f24.f8[2], &srcRoi_i4, &(dst_f24.f8[2]), 1, 0);

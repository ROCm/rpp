                                    ...
                                    rpp::Handle& handle)
{
    ...
    paramShape =  handle.GetInitHandle()->mem.mgpu.scratchBufferPinned.uintmem;
    paramStrides = handle.GetInitHandle()->mem.mgpu.scratchBufferPinned.uintmem + (batchSize * tensorDims);

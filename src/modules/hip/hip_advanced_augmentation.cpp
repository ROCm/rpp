...
RppStatus
color_cast_hip_batch(Rpp8u* srcPtr, Rpp8u* dstPtr, rpp::Handle &handle, RPPTensorFunctionMetaData &tensor_info)
{
    int in_plnpkdind = getplnpkdind(tensor_info._in_format), out_plnpkdind = getplnpkdind(tensor_info._out_format);
    InitHandle *handle_obj = handle.GetInitHandle();
    Rpp32u max_height, max_width;
...
{
//     int in_plnpkdind = getplnpkditensor_info._in_format), out_plnpkdind = getplnpkdind(tensor_info._out_format);
//     InitHandle *handle_obj = handle.GetInitHandle();
//     Rpp32u max_height, max_width;
//     max_size(handle_obj->mem.mgpu.csrcSize.height, handle_obj->mem.mgpu.csrcSize.width, handle.GetBatchSize(), &max_height, &max_width);
// #if defined (HIPRTC)
...
RppStatus
crop_and_patch_hip_batch(Rpp8u* srcPtr1, Rpp8u* srcPtr2, Rpp8u* dstPtr, rpp::Handle &handle, RPPTensorFunctionMetaData &tensor_info)
{
    int in_plnpkdind = getplnpkdind(tensor_info._in_format), out_plnpkdind = getplnpkdind(tensor_info._out_format);
    InitHandle *handle_obj = handle.GetInitHandle();
    Rpp32u max_height, max_width;
...
// #if defined (HIPRTC)
// #elif defined(STATIC)
//     // hip_exec_crop_and_patch_batch_tensor_fp16(srcPtr1, srcPtr2, dstPtr, handle, in_plnpkdind, out_plnpkdind, max_height, max_width);
// #endif
    return RPP_SUCCESS;
}
...
RppStatus
glitch_hip_batch(Rpp8u* srcPtr, Rpp8u* dstPtr, rpp::Handle &handle, RPPTensorFunctionMetaData &tensor_info)
{
    int in_plnpkdind = getplnpkdind(tensor_info._in_format), out_plnpkdind = getplnpkdind(tensor_info._out_format);
    InitHandle *handle_obj = handle.GetInitHandle();
    Rpp32u max_height, max_width;
...
// #if defined (HIPRTC)
// #elif defined(STATIC)
//      hip_exec_glitch_batch_tensor_fp16(srcPtr1, srcPtr2, dstPtr, handle, in_plnpkdind, out_plnpkdind, max_height, max_width);
// #endif
    return RPP_SUCCESS;
}

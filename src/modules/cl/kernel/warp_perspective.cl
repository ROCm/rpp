__kernel void warp_perspective_pln (  __global unsigned char* srcPtr,
                            __global unsigned char* dstPtr,
                            __global  float* perspective,
...
__kernel void warp_perspective_pkd (  __global unsigned char* srcPtr,
                            __global unsigned char* dstPtr,
                            __global  float* perspective,
                            const unsigned int source_height,
                            const unsigned int source_width,
...
__kernel void warp_perspective_batch(    __global unsigned char* srcPtr,
                                    __global unsigned char* dstPtr,
                                    __global float *perspective,

...
__kernel void resize_batch         (__global unsigned char* srcPtr,
                                    __global unsigned char* dstPtr,
...
__kernel void resize_crop_batch(    __global unsigned char* srcPtr,
                                    __global unsigned char* dstPtr,
                                    __global unsigned int *source_height,
                                    __global unsigned int *source_width,
                                    __global unsigned int *dest_height,
...
__kernel void resize_crop_batch_fp16( __global  half* srcPtr,
...
__kernel void resize_crop_mirror_batch(    __global unsigned char* srcPtr,
                                    __global unsigned char* dstPtr,
                                    __global unsigned int *source_height,
                                    __global unsigned int *source_width,
                                    __global unsigned int *dest_height,
...
__kernel void resize_crop_mirror_batch_fp16(__global half* srcPtr,
                                    __global half* dstPtr,
                                    __global unsigned int *source_height,
                                    __global unsigned int *source_width,
                                    __global unsigned int *dest_height,
...
__kernel void resize_crop_mirror_batch_fp32(    __global float* srcPtr,
                                    __global float* dstPtr,
                                    __global unsigned int *source_height,
                                    __global unsigned int *source_width,
                                    __global unsigned int *dest_height,

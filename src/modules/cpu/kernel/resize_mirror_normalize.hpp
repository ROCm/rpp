...
//                     __m256 pSrc[12], pDst[3];
//                     __m256 negativeLocMask;
//                     computeFnSrcLocAvx(pDstLoc, pWRatio, srcLocationColumnArray, &pWeightParams[2], negativeLocMask, pWOffset, true);   // Compute the src col location correspoding to the dst col location
//                     if(srcLocationColumnArray[7] >= widthLimit) break;
//                     compute_bilinear_coefficients_avx(pWeightParams, pBilinearCoeffs);                              // Compute Bilinear coefficients
...
//                     __m256 negativeLocMask;
//                     computeFnSrcLocAvx(pDstLoc, pWRatio, srcLocationColumnArray, &pWeightParams[2], negativeLocMask, pWOffset, false); // Compute the src col location correspoding to the dst col location
//                     if(srcLocationColumnArray[7] >= widthLimit) break;
//                     compute_bilinear_coefficients_avx(pWeightParams, pBilinearCoeffs);  // Compute Bilinear coefficients

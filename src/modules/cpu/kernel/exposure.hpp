    ...
    for(int batchCount = 0; batchCount < dstDescPtr->n; batchCount++)
    {
        ...
        if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NHWC) && (dstDescPtr->layout == RpptLayout::NCHW))
        {
            ...
            for(int i = 0; i < roi.xywhROI.roiHeight; i++)
            {
                ...
                {
                    *dstPtrTempR = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (srcPtrTemp[0])) * multiplyingFactor));
                    *dstPtrTempG = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (srcPtrTemp[1])) * multiplyingFactor));
                    *dstPtrTempB = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (srcPtrTemp[2])) * multiplyingFactor));
        ...
        else if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NCHW) && (dstDescPtr->layout == RpptLayout::NHWC))
        {
            ...
            for(int i = 0; i < roi.xywhROI.roiHeight; i++)
            {
                ...
                {
                    dstPtrTemp[0] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (*srcPtrTempR)) * multiplyingFactor));
                    dstPtrTemp[1] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (*srcPtrTempG)) * multiplyingFactor));
                    dstPtrTemp[2] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (*srcPtrTempB)) * multiplyingFactor));
        ...
        else
        {
            ...
            for(int c = 0; c < layoutParams.channelParam; c++)
            {
                ...
                for(int i = 0; i < roi.xywhROI.roiHeight; i++)
                {
                    ...
                    for (; vectorLoopCount < bufferLength; vectorLoopCount++)
                    {
                        *dstPtrTemp = (Rpp8u) std::nearbyintf(RPPPIXELCHECK(((Rpp32f) (*srcPtrTemp)) * multiplyingFactor));

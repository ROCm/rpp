        ...
        if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NHWC) && (dstDescPtr->layout == RpptLayout::NCHW))
        {
            if(mirrorFlag == 0)
            {
                ...
                for(int i = 0; i < roi.xywhROI.roiHeight; i++)
                {
                    ...
                    {
                        *dstPtrTempR = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[0] * multiplierTensor[cmnParamLocs[0]]) + offsetTensor[cmnParamLocs[0]]))));
                        *dstPtrTempG = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[1] * multiplierTensor[cmnParamLocs[1]]) + offsetTensor[cmnParamLocs[1]]))));
                        *dstPtrTempB = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[2] * multiplierTensor[cmnParamLocs[2]]) + offsetTensor[cmnParamLocs[2]]))));
        ...
        else if ((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NCHW) && (dstDescPtr->layout == RpptLayout::NHWC))
        {
            if(mirrorFlag == 0)
            {
                ...
                for(int i = 0; i < roi.xywhROI.roiHeight; i++)
                {
                    ...
                    {
                        dstPtrTemp[0] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (*srcPtrTempR)) * multiplierTensor[cmnParamLocs[0]]) + offsetTensor[cmnParamLocs[0]]));
                        dstPtrTemp[1] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (*srcPtrTempG)) * multiplierTensor[cmnParamLocs[1]]) + offsetTensor[cmnParamLocs[1]]));
                        dstPtrTemp[2] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (*srcPtrTempB)) * multiplierTensor[cmnParamLocs[2]]) + offsetTensor[cmnParamLocs[2]]));
        ...
        else if((srcDescPtr->c == 3) && (srcDescPtr->layout == RpptLayout::NHWC) && (dstDescPtr->layout == RpptLayout::NHWC))
        {
            if(mirrorFlag == 0)
            {
                ...
                for(int i = 0; i < roi.xywhROI.roiHeight; i++)
                {
                    ...
                    for (; vectorLoopCount < bufferLength; vectorLoopCount += 3)
                    {
                        dstPtrTemp[0] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[0] * multiplierTensor[cmnParamLocs[0]]) + offsetTensor[cmnParamLocs[0]]))));
                        dstPtrTemp[1] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[1] * multiplierTensor[cmnParamLocs[1]]) + offsetTensor[cmnParamLocs[1]]))));
                        dstPtrTemp[2] = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (srcPtrTemp[2] * multiplierTensor[cmnParamLocs[2]]) + offsetTensor[cmnParamLocs[2]]))));
                        srcPtrTemp += 3;
                        dstPtrTemp += 3;
                    }
                    srcPtrRow += srcDescPtr->strides.hStride;
            ...
            if(mirrorFlag == 0)
            {
                ...
                for(int c = 0; c < layoutParams.channelParam; c++)
                {
                    ...
                    for(int i = 0; i < roi.xywhROI.roiHeight; i++)
                    {
                        ...
                        for (; vectorLoopCount < bufferLength; vectorLoopCount++)
                        {
                            *dstPtrTemp = (Rpp8u) std::nearbyintf(RPPPIXELCHECK((((Rpp32f) (*srcPtrTemp)) * multiplierTensor[cmnParamLocs[c]]) + offsetTensor[cmnParamLocs[c]]));

...
extern "C" __global__ void non_max_suppression_pkd(   unsigned char* input,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
                    const unsigned int channel,
...
extern "C" __global__ void non_max_suppression_pln(   unsigned char* input,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
                    const unsigned int channel,
...
extern "C" __global__ void non_max_suppression_batch(   unsigned char* input,
                                     unsigned char* output,
                                     unsigned int *kernelSize,
                                     int *xroi_begin,
                                     int *xroi_end,
...
extern "C" __global__ void lens_correction_batch(     unsigned char* input,
                                    ...
                                    const int plnpkdindex,
                                    const unsigned int batch_size);
extern "C" __global__ void absolute_difference_batch(   unsigned char* input1,
                                     unsigned char* input2,
                                     unsigned char* output,
                                     int *xroi_begin,
                                     int *xroi_end,
...
extern "C" __global__ void magnitude_batch(   unsigned char* input1,
                                     unsigned char* input2,
                                     unsigned char* output,
                                     int *xroi_begin,
                                     int *xroi_end,
...
extern "C" __global__ void magnitude(   unsigned char* input1,
                     unsigned char* input2,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
...
extern "C" __global__ void multiply_batch(   unsigned char* input1,
                                     unsigned char* input2,
                                     unsigned char* output,
                                     int *xroi_begin,
                                     int *xroi_end,
...
extern "C" __global__ void multiply(   unsigned char* input1,
                     unsigned char* input2,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
...
extern "C" __global__ void dilate_pkd(   unsigned char* input,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
                    const unsigned int channel,
...
extern "C" __global__ void dilate_pln(   unsigned char* input,
                     unsigned char* output,
                    const unsigned int height,
                    const unsigned int width,
                    const unsigned int channel,
...
extern "C" __global__ void dilate_batch(   unsigned char* input,
                                     unsigned char* output,
                                     unsigned int *kernelSize,
                                     int *xroi_begin,
                                     int *xroi_end,
...
// __device__ unsigned char brightness(unsigned char input_pixel,double alpha,double beta);
/* This file was automatically generated.  Do not edit! */
...
// extern "C" __global__ void scan(int *input,int *output,__local int *b,__local int *c);
...
{
    static const std::map<std::string, const void*> data{{"absolute_difference",reinterpret_cast<const void*>(absolute_difference)},
                                                        ...
                                                        {"occlusion_pln",reinterpret_cast<const void*>(occlusion_pln)},
                                                        {"occlusion_pkd",reinterpret_cast<const void*>(occlusion_pkd)},

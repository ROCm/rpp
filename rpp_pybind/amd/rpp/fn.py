...
def brightness(images, alpha=1.0, beta=0.0, backend=None):
    ...
    print(f"DEBUG: handle type = {type(handle)}, value = {handle}")
    print(f"DEBUG: backend_int = {backend_int}")
    print(f"DEBUG: alpha_array = {[float(alpha)] * batch_size}")
    print(f"DEBUG: beta_array = {[float(beta)] * batch_size}")
...
def gamma_correction(images, gamma=1.0, backend=None):
    ...
    handle = rppCreate(batch_size, backend_int)
    print(f"DEBUG: Gamma handle type = {type(handle)}, value = {handle}")
    print(f"DEBUG: Gamma backend_int = {backend_int}")

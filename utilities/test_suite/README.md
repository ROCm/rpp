...
## Command Line Arguments (Rpp Image Tests)
...
## Running the Tests for HOST Backend (Rpp Image Tests)
...
## Running the Tests for HIP Backend (Rpp Image Tests)
The test suite can be run with the following command:
...
## Modes of operation (Rpp Image Tests)
...
## Command Line Arguments (Rpp Audio tests)

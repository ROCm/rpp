...
int main(int argc, char **argv)
{
    ...
    case 21:
    {
        ...
        for (i = 0; i < images; i++)
        {
            dstImgSizes[i].width = roiTensorPtrDst[i].xywhROI.roiWidth = 100;//roiTensorPtrSrc[i].xywhROI.roiWidth;
            dstImgSizes[i].height = roiTensorPtrDst[i].xywhROI.roiHeight = 120;//roiTensorPtrSrc[i].xywhROI.roiHeight;
        }

...
int main(int argc, char **argv)
{
    ...
    case 38:
    {
        ...
        int *d_combinedImages;
        hipMalloc(&d_combinedImages, threeChannelBufferSize * sizeof(Rpp8u));
    ...
    case 46:
    {
        ...
        if (ip_bitDepth == 0)
            rppi_look_up_table_u8_pln1_batchPD_gpu(d_input, srcSize, maxSize, d_output, lut8u, noOfImages, handle);
        else if (ip_bitDepth == 1)
            missingFuncFlag = 1;
        else if (ip_bitDepth == 2)
            missingFuncFlag = 1;

...
// {
//     const int MIN_ARG_COUNT = 6;
//     printf("\nUsage: ./BatchPD_ocl <src1 folder> <src2 folder (place same as src1 folder for single image functionalities)> <dst folder> <u8 = 0 / f16 = 1 / f32 = 2> <case number = 0:64>\n");
//     if (argc < MIN_ARG_COUNT)
//     {
//         printf("\nImproper Usage! Needs all arguments!\n");
//         return -1;

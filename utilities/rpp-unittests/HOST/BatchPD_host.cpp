...
rppi_fast_corner_detector_u8_pkd3_batchPD_host(input, srcSize, maxSize, output, numOfPixels, threshold, nonmaxKernelSize, noOfImages, handle);
	...
	rppi_harris_corner_detector_u8_pkd3_batchPD_host(input, srcSize, maxSize, output, gaussianKernelSize, stdDev, kernelSize, kValue, threshold1, nonmaxKernelSize, noOfImages, handle);
  ...
  case 61:
	...
	rppi_resize_crop_mirror_u8_pkd3_batchPD_host(input, srcSize, maxSize, output, dstSize, maxDstSize, xRoiBegin,xRoiEnd, yRoiBegin,yRoiEnd,mirrorFlag, noOfImages, handle);

        break;
  case 62:
        test_case_name = "crop";
	rppi_crop_u8_pkd3_batchPD_host(input, srcSize, maxSize, output, dstSize, maxDstSize, xRoiBegin, yRoiBegin, noOfImages, handle);
        break;
 case 63:

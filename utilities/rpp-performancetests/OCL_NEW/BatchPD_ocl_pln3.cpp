...
int main(int argc, char **argv)
{
    ...
    for (int perfRunCount = 0; perfRunCount < 100; perfRunCount++)
    {
        ...
        case 23:
        {
            ...
            if (ip_bitDepth == 0)
                rppi_histogram_balance_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_output, noOfImages, handle);
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
                missingFuncFlag = 1;
        ...
        case 38:
        {
            ...
            if (ip_bitDepth == 0)
            {
                rppi_channel_extract_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_channel1, extractChannelNumber1, noOfImages, handle);
                rppi_channel_extract_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_channel2, extractChannelNumber2, noOfImages, handle);
                rppi_channel_extract_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_channel3, extractChannelNumber3, noOfImages, handle);
                rppi_channel_combine_u8_pln3_batchPD_gpu(d_channel1, d_channel2, d_channel3, srcSize, maxSize, d_output, noOfImages, handle);
            }
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
        ...
        case 41:
        {
            ...
            if (ip_bitDepth == 0)
                rppi_histogram_equalization_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_output, noOfImages, handle);
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
                missingFuncFlag = 1;
        ...
        case 43:
        {
            ...
            if (ip_bitDepth == 0)
                rppi_integral_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_output32u, noOfImages, handle);
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
                missingFuncFlag = 1;
        ...
        case 69:
        {
            ...
            if (ip_bitDepth == 0)
                rppi_custom_convolution_u8_pln3_batchPD_gpu(d_input, srcSize, maxSize, d_output, kernel, kernelSize, noOfImages, handle);
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
                missingFuncFlag = 1;
        ...
        case 70:
        {
            ...
            if (ip_bitDepth == 0)
                rppi_reconstruction_laplacian_image_pyramid_u8_pln3_batchPD_gpu(d_srcPtr1, srcSize, srcSize1Max, d_srcPtr2, srcSizeHalf, srcSize2Max, d_output, stdDev, kernelSize, noOfImages, handle);
            else if (ip_bitDepth == 1)
                missingFuncFlag = 1;
            else if (ip_bitDepth == 2)
                missingFuncFlag = 1;

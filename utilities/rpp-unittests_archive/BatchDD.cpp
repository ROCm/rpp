...
int main(int argc, char **argv)
{
    ...
    char funcType[1000] = {"batchDD_OCL_PKD3"};
    ...
    case 0:
    {
        ...
        start = clock();
            rppi_brightness_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, alpha, beta, noOfImages, handle);
        end = clock();
    ...
    case 1:
    {
        ...
        start = clock();
            ...
            rppi_contrast_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, newMin, newMax, noOfImages, handle);
    ...
    case 2:
    {
        ...
        start = clock();
            ...
            rppi_blur_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 3:
    {
        ...
        start = clock();
            ...
            rppi_jitter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 4:
    {
        ...
        start = clock();
            ...
            rppi_blend_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, alpha, noOfImages, handle);
    ...
    case 5:
    {
        ...
        start = clock();
            ...
            rppi_color_temperature_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, adjustmentValue, noOfImages, handle);
    ...
    case 6:
    {
        ...
        start = clock();
            ...
            rppi_gamma_correction_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, gamma, noOfImages, handle);
    ...
    case 7:
    {
        ...
        start = clock();
            ...
            rppi_fog_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, fogValue, noOfImages, handle);
    ...
    case 8:
    {
        ...
        start = clock();
            ...
            rppi_snow_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, snowPercentage, noOfImages, handle);
    ...
    case 9:
    {
        ...
        start = clock();
            ...
            rppi_lens_correction_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, strength, zoom, noOfImages, handle);
    ...
    case 10:
    {
        ...
        start = clock();
            ...
            rppi_noise_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noiseProbability, noOfImages, handle);
    ...
    case 11:
    {
        ...
        start = clock();
            ...
            rppi_pixelate_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 12:
    {
        ...
        start = clock();
            ...
            rppi_exposure_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, exposureFactor, noOfImages, handle);
    ...
    case 13:
    {
        ...
        start = clock();
            ...
            rppi_fisheye_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 14:
    {
        ...
        start = clock();
            ...
            rppi_vignette_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, stdDev, noOfImages, handle);
    ...
    case 15:
    {
        ...
        start = clock();
            ...
            rppi_flip_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, flipAxis, noOfImages, handle);
    ...
    case 16:
    {
        ...
        start = clock();
            ...
            rppi_rain_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, rainPercentage, rainWidth, rainHeight, transparency, noOfImages, handle);
    ...
    case 17:
    {
        ...
        start = clock();
            ...
            rppi_rotate_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, dstSize,  angle, noOfImages, handle);
    ...
    case 18:
    {
        ...
        start = clock();
            ...
            rppi_warp_affine_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output,  dstSize, affine_array, noOfImages, handle);
    ...
    case 19:
    {
        ...
        start = clock();
            ...
            rppi_resize_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, dstSize,noOfImages, handle);
    ...
    case 20:
    {
        ...
        start = clock();
            ...
            rppi_resize_crop_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, dstSize,  x1, x2, y1, y2, noOfImages, handle);
    ...
    case 21:
    {
        ...
        start = clock();
            ...
            rppi_hueRGB_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, hueShift, noOfImages, handle);
    ...
    case 22:
    {
        ...
        start = clock();
            ...
            rppi_saturationRGB_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, saturationFactor, noOfImages, handle);
    ...
    case 23:
    {
        ...
        start = clock();
            ...
            rppi_histogram_balance_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 24:
    {
        ...
        start = clock();
            ...
            rppi_random_shadow_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, x1, y1, x2, y2, numbeoOfShadows, maxSizeX, maxSizey, noOfImages, handle);
    ...
    case 25:
    {
        ...
        start = clock();
            ...
            rppi_random_crop_letterbox_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output,  dstSize, x1, x2, y1, y2, noOfImages, handle);
    ...
    case 26:
    {
        ...
        start = clock();
            ...
            rppi_absolute_difference_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 27:
    {
        ...
        start = clock();
            ...
            rppi_accumulate_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, noOfImages, handle);
    ...
    case 28:
    {
        ...
        start = clock();
            ...
            rppi_accumulate_squared_u8_pkd3_batchDD_gpu(d_input, srcSize, noOfImages, handle);
    ...
    case 29:
    {
        ...
        start = clock();
            ...
            rppi_accumulate_weighted_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, alpha, noOfImages, handle);
    ...
    case 30:
    {
        ...
        start = clock();
            ...
            rppi_add_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 31:
    {
        ...
        start = clock();
            ...
            rppi_subtract_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 32:
    {
        ...
        start = clock();
            ...
            rppi_bitwise_AND_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 33:
    {
        ...
        start = clock();
            ...
            rppi_exclusive_OR_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 34:
    {
        ...
        start = clock();
            ...
            rppi_inclusive_OR_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 35:
    {
        ...
        start = clock();
            ...
            rppi_bitwise_NOT_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 36:
    {
        ...
        start = clock();
            ...
            rppi_box_filter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 37:
    {
        ...
        start = clock();
            ...
            rppi_canny_edge_detector_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, minThreshold, maxThreshold, noOfImages, handle);
    ...
    case 38:
    {
        ...
        start = clock();
            ...
            rppi_channel_extract_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, extractChannelNumber, noOfImages, handle);
    ...
    case 39:
    {
        ...
        start = clock();
            ...
            rppi_data_object_copy_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 40:
    {
        ...
        start = clock();
            ...
            rppi_dilate_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 41:
    {
        ...
        start = clock();
            ...
            rppi_histogram_equalization_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 42:
    {
        ...
        start = clock();
            ...
            rppi_erode_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 43:
    {
        ...
        start = clock();
            ...
            rppi_fast_corner_detector_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, numOfPixels, threshold, nonmaxKernelSize, noOfImages, handle);
    ...
    case 44:
    {
        ...
        start = clock();
            ...
            rppi_gaussian_filter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, stdDev, kernelSize, noOfImages, handle);
    ...
    case 45:
    {
        ...
        start = clock();
            ...
            rppi_gaussian_image_pyramid_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, stdDev, kernelSize, noOfImages, handle);
    ...
    case 46:
    {
        ...
        start = clock();
            ...
            rppi_harris_corner_detector_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, gaussianKernelSize, stdDev, kernelSize, kValue, threshold, nonmaxKernelSize, noOfImages, handle);
    ...
    case 47:
    {
        ...
        start = clock();
            ...
            rppi_local_binary_pattern_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, noOfImages, handle);
    ...
    case 48:
    {
        ...
        start = clock();
            ...
            rppi_laplacian_image_pyramid_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, stdDev, kernelSize, noOfImages, handle);
    ...
    case 49:
    {
        ...
        start = clock();
            ...
            rppi_magnitude_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 50:
    {
        ...
        start = clock();
            ...
            rppi_max_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 51:
    {
        ...
        start = clock();
            ...
            rppi_median_filter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 52:
    {
        ...
        start = clock();
            ...
            rppi_min_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 53:
    {
        ...
        start = clock();
            ...
            rppi_nonlinear_filter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 54:
    {
        ...
        start = clock();
            ...
            rppi_non_max_suppression_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, kernelSize, noOfImages, handle);
    ...
    case 55:
    {
        ...
        start = clock();
            ...
            rppi_phase_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 56:
    {
        ...
        start = clock();
            ...
            rppi_multiply_u8_pkd3_batchDD_gpu(d_input, d_input_second, srcSize, d_output, noOfImages, handle);
    ...
    case 57:
    {
        ...
        start = clock();
            ...
            rppi_scale_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output,dstSize,   percentage, noOfImages, handle);
    ...
    case 58:
    {
        ...
        start = clock();
            ...
            rppi_sobel_filter_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, sobelType, noOfImages, handle);
    ...
    case 59:
    {
        ...
        start = clock();
            ...
            rppi_thresholding_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, min, max, noOfImages, handle);
    ...
    case 60:
    {
        ...
        start = clock();
            ...
            rppi_warp_perspective_u8_pkd3_batchDD_gpu(d_input, srcSize, d_output, dstSize,  perspective, noOfImages, handle);
    ...
    cout << "\nOMP Time - BatchDD : " << cpu_time_used;;
